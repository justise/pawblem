...
<head>
    ...
    <meta name="Description" content="Forms to fill out for Pawblem Solved the Premier Pet Sitting and Dog Walking service in the Redmond, Kirkland and Bellevue areas.">
                ...
                <div class="yui3-g-r">
                    <div class="yui3-u-1-3">
                        <div class="grid-wrapper">
                            ...
                            <p>
							    <a href="downloads/Pawblem Solved Client Forms.pdf" target="_blank" title="Download PDF">New Client Form &gt;</a>
                            </p>
                        </div>
                    </div>
                    <div class="yui3-u-1-3">
                        <div class="grid-wrapper">
						    <h2>Form for Cats</h2>
                            <a href="downloads/Cat Information Sheet.pdf" target="_blank"><img src="images/tiles/cat7.jpg" alt="Cute Cat in Kirkland"/></a>
                            <p>
                    ...
                    <div class="yui3-u-1-3">
                        <div class="grid-wrapper">
						    ...
						    <p>
							    <a href="downloads/Dog Information Sheet.pdf" target="_blank" title="Download PDF">Dog Information Sheet &gt;</a>
						    </p>
                        </div>
                    </div>
                </div>
