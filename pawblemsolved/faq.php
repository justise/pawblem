				...
				<div class="section">
					...
					<div class="big-col">
						<p>
							...
							<a href="#bonded">Is Pawblem Solved Licensed, Bonded and Insured?</a><br/>
							<a href="#time">How much time do you spend at each visit with my pet?</a><br/>
							<a href="#group">Will my dog be walked individually or in a group?</a><br/>
							<a href="#who">Who will be walking my dog or taking care of my pets?</a><br/>
							<a href="#aggressive">If my pet has been / is aggressive, can I still use your service?</a><br/>
							<a href="#weather">Do you walk in any weather, all year long?</a><br/>
							<a href="#keys">When do I give you my keys?  How do I get them back from you?</a><br/>
							<a href="#twokeys">Why do you need two (2) keys?</a><br/>
							<a href="#payment">What type of payment do you accept?</a><br/>
							<a href="#servicehours">What are your service hours?</a><br/>
						</p>
						<br/>
						
						<h3 id="mission">What is your mission?</h3>
						<p>We solve your pawblems one paw at a time and provide peace of mind for owner and pet.</p>
						
						<h3 id="professional">Why should I hire a professional pet sitter?</h3>
						...
						<h3 id="bonded">Is Pawblem Solved Licensed, Bonded and Insured?</h3>
						...
						<h3 id="time">How much time do you spend at each visit with my pet?</h3>
						...
						<h3 id="group">Will my dog be walked individually or in a group?</h3>
						...
						<h3 id="who">Who will be walking my dog or taking care of my pets?</h3>
						...
						<h3 id="aggressive">If my pet has been / is aggressive, can I still use your service? </h3>
						...
						<h3 id="weather">Do you walk in any weather, all year long? </h3>
						...
						<h3 id="keys">When do I give you my keys?  How do I get them back from you? </h3>
						...
						<h3 id="twokeys">Why do you need two (2) keys?</h3>
						<p>
						...
						<h3 id="payment">What type of payment do you accept? </h3>
						<p>We accept cash and check. </p>

						<h3 id="servicehours">What are your service hours?</h3>
						<p>Pets are generally visited between the hours of 9:00am to 6:00pm and visits are divided into morning, midday and evening time periods. The actual time your pet is visited depends on a variety of logistical situations such as location, traffic, construction and proximity to other pet sitting clients.  Dogs on twice a day visits are always visited at 12 hour intervals.  We will try to get as close to a time that you request but cannot guarantee it.</p>

					</div>
				
					<div class="small-col text-align">
						<img src="images/dudley.jpg" width="200"/>
					</div>					
				</div>	
